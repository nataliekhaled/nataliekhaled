...
namespace Project.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public ActionResult Adams()
        {
            var students = db.Students.Where(student => student.FirstName.ToLower() == "adam").ToList();
            return View(students) ;
        }

        public ActionResult FavColor()
        {
            string color = "blue";
            var students = db.Students.Where(student => student.FavoriteColor.ToLower() == color).ToList();
            return View(students);
        }
